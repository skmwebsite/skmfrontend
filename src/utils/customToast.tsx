  ...
  toast.custom(
    (t) => (
      <motion.div
        ...
        className={
          " rounded-[1rem] z-[5000]  p-[1.25rem]  ~min-w-[18.75rem]/[22.5rem] lg:~max-w-[22.5rem]/[26.25rem] relative gap-[0.5rem] flex items-center overflow-hidden border border-[#00000033] bg-[#FFFFFF] shadow-[0_4px_24px_rgba(0,0,0,0.06),0_1px_3px_rgba(0,0,0,0.04)]  max-lg:~mb-[1rem]/[3.5rem] max-lg:w-full"
        }
      ...
      >
        ...
        <div className=" ~gap-3.5/5 flex w-full grow-1 items-start">
          ...
          {type === "cart" && (
            <button
              className="~text-[0.7rem]/[0.75rem] font-light tracking-[0.01em] absolute right-[1rem] bottom-[1rem]  text-main underline underline-offset-2 hover:opacity-50"
              onClick={() => {
                toast.dismiss(t.id);
                openCart();
              }}
